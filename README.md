# dummyDataSampleApplication - to build generator
...
To build the final jar and optimize the dummyDataSampleApplication application for production, run:
...
Then navigate to [http://localhost:8989](http://localhost:8989) in your browser.
